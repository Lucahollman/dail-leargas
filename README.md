...
-This setup file can at times take very long. To shorten this process, you can change the dates in api-query.py (found on line 52 and 53) to target a shorter period of time.
